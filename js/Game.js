class Game{
  ...
  displayRanks(){      
    ...
    image(bronzeMedalImage, displayWidth/-4, -100 + displayHeight/9, 200, 240);
    image(silverMedalImage, displayWidth/4, -100 + displayHeight/10, 225, 270);
    image(goldMedalImage, 0, -100, 250, 300);
